...
public class CertController extends BaseController {
    ...
    @SaCheckPermission("bcos:sys:certificate")
    @GetMapping("list")
    ...
    @SaCheckPermission("bcos:sys:downloadSdkCert")
     ...
     * @throws NodeMgrException
     */
    @Log(title = "BCOS2/系统管理/证书管理", businessType = BusinessType.INSERT)
    @SaCheckPermission("bcos:sys:addCert")
    @PostMapping("")
    ...
    @Log(title = "BCOS2/系统管理/证书管理", businessType = BusinessType.DELETE)
    @SaCheckPermission("bcos:sys:deleteCert")
    @DeleteMapping(value = "")
