...
public class DockerCommandService {
     ...
     * @return
     */
    public void pullImage(HostDTO hostDTO, String imageTag, int imagePullType) {
        ...
        if (DockerImageTypeEnum.PULL_OFFICIAL.getId() == imagePullType) {
            ...
            ansibleService.execPullDockerCdnShell(hostDTO, hostDTO.getRootDir() + "/download", imageTag, webaseVersion);
        }
